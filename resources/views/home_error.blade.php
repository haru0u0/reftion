...
<body id="page-top">
    ...
    <div class="container">
        <div class="text-center mt-5">
            <p>Oops! It looks like the tag information failed to load. Check our <a href="{{ url('/prepare') }}">{{ __('"Get Started"') }}</a> page once again and see if your settings all meet Reftion's requiremnts.
            </p>
