        ...
        <div class="text-center mt-5">
            ...
            <form method="POST" action="{{ url('/setting') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="input_name" type="text" class="form-control @error('name') is-invalid @enderror" name="input_name" value="{{$old_name}}" required autocomplete="name" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="input_email" type="email" class="form-control @error('email') is-invalid @enderror" name="input_email" value="{{$old_email}}" required autocomplete="email">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="input_password" type="password" class="form-control @error('password') is-invalid @enderror" name="input_password" required autocomplete="new-password">
                ...
                <div class="row mb-3">
                    <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Notion API Token') }}</label>
